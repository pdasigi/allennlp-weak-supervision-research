...
@Model.register("wikitables_variable_free_erm")
class WikiTablesVariableFreeErm(WikiTablesVariableFreeParser):
    """
    A ``WikiTablesVariableFreeErm`` is a :class:`WikiTablesVariableFreeSemanticParser` that learns to search
